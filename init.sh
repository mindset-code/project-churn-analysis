#!/usr/bin/env bash
# init.sh — project-churn-analysis (Python, Data Science)
set -euo pipefail
...
echo ""; info "project-churn-analysis — verificación pre-sesión"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

echo ""; info "Estructura"
check "churn_analysis.py existe" test -f "churn_analysis.py"
...
echo ""; info "Python — librerías data science"
check "pandas disponible"     python3 -c "import pandas"
check "numpy disponible"      python3 -c "import numpy"
check "sklearn disponible"    python3 -c "import sklearn"
check "matplotlib disponible" python3 -c "import matplotlib"

echo ""; info "Sintaxis"
check "churn_analysis.py"  python3 -m py_compile churn_analysis.py
check "generate_data.py"   python3 -m py_compile generate_data.py
